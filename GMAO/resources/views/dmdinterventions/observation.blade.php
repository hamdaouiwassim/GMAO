					...
					<div class="panel panel-headline">
						...
						<div class="col-md-12">
							...
							<div class="panel">
								...
								<div class="panel-body">
								<form action='/ot/addobservation/{{ $oi->id }}' method="POST" >
                                                        {{ csrf_field() }} 
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3">
                                                                <label > <label> Date fin </label> </label>
                                                                
                                                                </div>
                                                                <div class="col-md-9">
                                                                <input style="width:100%;margin-bottom:10px;" class="form-control"  type="datetime-local" name="date_fin">
