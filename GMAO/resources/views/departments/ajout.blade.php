				...
				<ul class="nav">
						...
						<li>
                         <a href="#subeqpmt" data-toggle="collapse" class="collapsed"><i class="lnr lnr-laptop-phone"></i> <span>Equipements</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
							...
							<li>
						<a href="#subdepartments" class="active" data-toggle="collapse" class="collapsed"><i class="lnr lnr-store"></i> <span>Departements</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
					...
					<div class="panel panel-headline">
						...
						<div class="col-md-12">
							...
							<div class="panel">
								...
								<div class="panel-heading">
									<h3 class="panel-title"> Ajouter d'un departement   </h3>
								</div>
