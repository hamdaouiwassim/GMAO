                                ...
                                <form action='/modequipement/{{ $equipement->id }}' method="POST" enctype="multipart/form-data">
                                                        {{ csrf_field() }} 
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-9">
                                                                <input style="width:100%;margin-bottom:10px;" class="form-control" value="{{ $equipement->name }}" type="text" name="name">
                                                                ...
                                                                <div class="col-md-9">
                                                                <textarea style="width:100%;margin-bottom:10px;" class="form-control"  name="description">{{ $equipement->description }}</textarea>
                                                                ...
                                                                <div class="col-md-9">
                                                                <input style="width:100%;margin-bottom:10px;" class="form-control" value="{{ $equipement->numero }}" type="number" name="numero">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <input style="width:100%;margin-bottom:10px;" class="form-control" value="{{ $equipement->emplacement }}" type="text" name="emplacement">
