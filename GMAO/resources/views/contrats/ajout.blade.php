					...
					<div class="panel panel-headline">
						...
						<div class="col-md-12">
							...
							<div class="panel">
								...
								<div class="panel-heading">
									<h3 class="panel-title"> Ajouter d'un contrat du maintenance  </h3>
								</div>
                                ...
                                <form action='/addcontrat' method="POST" >
                                                        {{ csrf_field() }} 
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-9">
                                                                <input style="width:100%;margin-bottom:10px;" class="form-control" placeholder="Tapper le nom du contrat içi" type="text" name="contratname">
                                                                ...
                                                                <div class="col-md-9">
                                                                <input style="width:100%;margin-bottom:10px;" class="form-control" placeholder="Tapper la nom du societe içi" type="text" name="societe">
