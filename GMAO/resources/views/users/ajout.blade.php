					...
					<div class="panel panel-headline">
						...
						<div class="col-md-12">
							...
							<div class="panel">
								...
								<div class="panel-heading">
									<h3 class="panel-title"> Ajouter d'un utilisateur   </h3>
								</div>
                                ...
                                <form action='/adduser' method="POST" >
                                                        {{ csrf_field() }} 
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-9">
                                                                <input style="width:100%;margin-bottom:10px;" class="form-control" placeholder="Tapper le nom utilisateur içi" type="text" name="username">
                                                                ...
                                                                <div class="col-md-9">
                                                                <input style="width:100%;margin-bottom:10px;" class="form-control" placeholder="Tapper la matricule utilisateur içi" type="text" name="usermat">
                                                                ...
                                                                <div class="col-md-9">
                                                                <input style="width:100%;margin-bottom:10px;" class="form-control" placeholder="Tapper l'email içi" type="email" name="usermail">
                                                                ...
                                                                <div class="col-md-9">
                                                                <input style="width:100%;margin-bottom:10px;" class="form-control" placeholder="Tapper le mot de passe içi " type="password" name="userpw">
                                                                ...
                                                                <div class="col-md-9">
                                                                <input style="width:100%;margin-bottom:10px;" class="form-control" placeholder="Repeter le mot de passe içi " type="password" name="userrpw">
